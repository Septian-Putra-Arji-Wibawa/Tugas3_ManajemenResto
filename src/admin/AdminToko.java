...
public class AdminToko {
    ...
    public AdminToko(menu.Menu menu) {
        this.menu = menu;
    }
    ...
    public void menuAdmin() {
        ...
        System.out.println("Pilih satu fungsi dibawah:");
        System.out.println("1. Tambah menu");
        System.out.println("2. Ubah harga");
        System.out.println("3. Hapus menu");
        System.out.println("4. Cetak Menu");
        System.out.println("5. Tampilkan Menu");
    ...
    private void tambahMenu() {
        ...
        while (true) {
            ...
            scanner.nextLine(); // Co   nsuming the newline character
